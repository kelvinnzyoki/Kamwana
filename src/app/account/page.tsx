...
function OtpModal({
  ...
  // The OTP was already auto-sent by PATCH /api/auth/profile, so the
  // timer starts immediately rather than waiting for a first resend.
  const COOLDOWN = 60;
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
      <div className="w-full max-w-sm rounded-3xl border border-border bg-background p-6 space-y-4">
        ...
        <p className="text-sm opacity-60">
          A 6-digit code was sent to your {type === 'phone' ? 'phone' : 'email'}.
        </p>
...
// value to their account and auto-sends an OTP for immediate verification.
